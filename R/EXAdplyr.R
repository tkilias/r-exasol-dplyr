...
#'
#' @field host 
#' @field port The port where the db listens.
#' @field user The DB user name. DEFAULT: 'sys'.
#' @field password The user's password. DEFAULT: 'exasol'.
#' @field ... Further parameters, to be passed on to dbConnect.
#' @field dsn The ODBC dsn to connect to.
#' @field driver The ODBC driver library to use.
#' @export
